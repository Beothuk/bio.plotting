...
#' @param \code{pt.cex.min} the default is \code{NULL}. When \code{use.buckets = F}, this determines the size of the points, and when \code{use.buckets = T}, this determines the minimum size of the points to be drawn.  If unspecified, the value from p.plotting will be used.
#' @param \code{pt.cex.max} the default is \code{NULL}. When \code{use.buckets = F}, this is ignored, and when \code{use.buckets = T}, this determines the maximum size of the points to be drawn.  If unspecified, the value from p.plotting will be used.
...
#' @examples
#'  add.points(p.plotting, df, map, lat.field='LAT', lon.field='LON', plot.field='WEIGHT_SMOOTHED', plot.field.pretty='WEIGHT', use.buckets=T, classes=10, pt.cex.max=1, pt.cex.max=1.5)
#' @family plotting
