...
#' 
#' @param known.areas default is \code{NULL}. Valid values include the following:
#' \itemize{
#'   \item Bowtie
#'   \item LFA40
...
#' }
#' @param known.areas.detailed default is \code{F}.  Some areas are complex and contains sub-areas, and may not be appropriate for all plots.
...
#' @importFrom sp getSpPPolygonsLabptSlots
...
#' @export
get_known_areas <- function(known.areas=NULL, known.areas.detailed= NULL)
{
