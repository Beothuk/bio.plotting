#' @title get.DFO.areas
#' @description This function returns a list of requested SpatialPolygons of areas of interest to DFO.  
#' @param \code{requested} default is \code{"All"}. Valid values include the following:
#' \itemize{
...
#'   \item Haldimand
#'   \item Shortland
#'   \item All (plots everything above)
#'   \item MPA (just plots Gully and Musquash*)
#'   \item CCA (just plots Vazella_Emerald, Vazella_Sambro, NE_Channel and Gully)
#' }
